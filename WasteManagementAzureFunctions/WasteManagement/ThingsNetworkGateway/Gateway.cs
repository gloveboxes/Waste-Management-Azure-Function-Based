...
namespace WasteManagement.ThingsNetworkGateway
{
    ...
    {
        static TelemetryEntity telemetry = new TelemetryEntity();
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            await PostDataToIoTHub(host, key, ttn.dev_id, result, ttn);
        ...
        public static async Task<bool> PostDataToIoTHub(string host, string key, string deviceId, uint data, TtnEntity ttn)
        {
            ...
            var content = new StringContent(telemetry.ToJson(deviceId, data));
